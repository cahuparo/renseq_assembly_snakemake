...
build_time_vars = {'ABIFLAGS': 'm',
 ...
 'CONFIG_ARGS': "'--prefix=/data/run/chparada/renseq_assembly_snakemake/env_snakemake' "
                ...
                "-I/data/run/chparada/renseq_assembly_snakemake/env_snakemake/include' "
                "'CPP=/data/run/chparada/renseq_assembly_snakemake/env_snakemake/bin/i686-conda_cos6-linux-gnu-cpp' "
 ...
 'LIBPL': '/data/run/chparada/renseq_assembly_snakemake/env_snakemake/lib/python3.6/config-3.6m-i386-linux-gnu',

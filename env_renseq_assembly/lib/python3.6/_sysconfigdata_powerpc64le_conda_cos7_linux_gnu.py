...
build_time_vars = {'ABIFLAGS': 'm',
 ...
 'BASEMODLIBS': '',
 'BINDIR': '/data/run/chparada/renseq_assembly_snakemake/env_renseq_assembly/bin',
 'BINLIBDEST': '/data/run/chparada/renseq_assembly_snakemake/env_renseq_assembly/lib/python3.6',
 'BLDLIBRARY': 'libpython3.6m.a',
 'BLDSHARED': 'powerpc64le-conda_cos7-linux-gnu-gcc -pthread -shared -Wl,-O2 '
              '-Wl,--sort-common -Wl,--as-needed -Wl,-z,relro -Wl,-z,now '
              '-Wl,-rpath,/data/run/chparada/renseq_assembly_snakemake/env_renseq_assembly/lib '
              '-L/data/run/chparada/renseq_assembly_snakemake/env_renseq_assembly/lib '
 ...
 'CFLAGS': '-Wno-unused-result -Wsign-compare -DNDEBUG -fwrapv -O2 -Wall '
           ...
           '-fdebug-prefix-map=/data/run/chparada/renseq_assembly_snakemake/env_renseq_assembly=/usr/local/src/conda-prefix '
           '-pipe     '
 ...
 'CONFIGURE_CPPFLAGS': '-D_FORTIFY_SOURCE=2 -O2 '
                       '-I/data/run/chparada/renseq_assembly_snakemake/env_renseq_assembly/include',
 'CONFIGURE_LDFLAGS': '-Wl,-O2 -Wl,--sort-common -Wl,--as-needed -Wl,-z,relro '
                      '-Wl,-z,now '
                      '-Wl,-rpath,/data/run/chparada/renseq_assembly_snakemake/env_renseq_assembly/lib '
                      '-L/data/run/chparada/renseq_assembly_snakemake/env_renseq_assembly/lib',
 'CONFIG_ARGS': "'--prefix=/data/run/chparada/renseq_assembly_snakemake/env_renseq_assembly' "
                ...
                "'--with-tcltk-includes=-I/data/run/chparada/renseq_assembly_snakemake/env_renseq_assembly/include' "
                "'--with-tcltk-libs=-L/data/run/chparada/renseq_assembly_snakemake/env_renseq_assembly/lib "
                ...
                "-I/data/run/chparada/renseq_assembly_snakemake/env_renseq_assembly/include' "
                "'CPP=/data/run/chparada/renseq_assembly_snakemake/env_renseq_assembly/bin/powerpc64le-conda_cos7-linux-gnu-cpp' "
                "'PKG_CONFIG_PATH=/data/run/chparada/renseq_assembly_snakemake/env_renseq_assembly/lib/pkgconfig'",
 'CONFINCLUDEDIR': '/data/run/chparada/renseq_assembly_snakemake/env_renseq_assembly/include',
 'CONFINCLUDEPY': '/data/run/chparada/renseq_assembly_snakemake/env_renseq_assembly/include/python3.6m',
 'COREPYTHONPATH': ':',
 ...
 'DESTDIRS': '/data/run/chparada/renseq_assembly_snakemake/env_renseq_assembly '
             '/data/run/chparada/renseq_assembly_snakemake/env_renseq_assembly/lib '
             '/data/run/chparada/renseq_assembly_snakemake/env_renseq_assembly/lib/python3.6 '
             '/data/run/chparada/renseq_assembly_snakemake/env_renseq_assembly/lib/python3.6/lib-dynload',
 'DESTLIB': '/data/run/chparada/renseq_assembly_snakemake/env_renseq_assembly/lib/python3.6',
 'DESTPATH': '',
 'DESTSHARED': '/data/run/chparada/renseq_assembly_snakemake/env_renseq_assembly/lib/python3.6/lib-dynload',
 'DFLAGS': '',
 'DIRMODE': 755,
 ...
 'INCLDIRSTOMAKE': '/data/run/chparada/renseq_assembly_snakemake/env_renseq_assembly/include '
                   '/data/run/chparada/renseq_assembly_snakemake/env_renseq_assembly/include '
                   '/data/run/chparada/renseq_assembly_snakemake/env_renseq_assembly/include/python3.6m '
                   '/data/run/chparada/renseq_assembly_snakemake/env_renseq_assembly/include/python3.6m',
 'INCLUDEDIR': '/data/run/chparada/renseq_assembly_snakemake/env_renseq_assembly/include',
 'INCLUDEPY': '/data/run/chparada/renseq_assembly_snakemake/env_renseq_assembly/include/python3.6m',
 ...
 'LDVERSION': '3.6m',
 'LIBC': '',
 'LIBDEST': '/data/run/chparada/renseq_assembly_snakemake/env_renseq_assembly/lib/python3.6',
 'LIBDIR': '/data/run/chparada/renseq_assembly_snakemake/env_renseq_assembly/lib',
 'LIBFFI_INCLUDEDIR': '/data/run/chparada/renseq_assembly_snakemake/env_renseq_assembly/include',
 'LIBM': '-lm',
 'LIBOBJDIR': 'Python/',
 'LIBOBJS': '',
 'LIBPC': '/data/run/chparada/renseq_assembly_snakemake/env_renseq_assembly/lib/pkgconfig',
 'LIBPL': '/data/run/chparada/renseq_assembly_snakemake/env_renseq_assembly/lib/python3.6/config-3.6m-powerpc64le-linux-gnu',
 ...
 'MACHDEPPATH': ':',
 'MACHDEP_OBJS': '',
 'MACHDESTLIB': '/data/run/chparada/renseq_assembly_snakemake/env_renseq_assembly/lib/python3.6',
 ...
 'MANDIR': '/data/run/chparada/renseq_assembly_snakemake/env_renseq_assembly/share/man',
 ...
 'RETSIGTYPE': 'void',
 'RUNSHARED': '',
 'SCRIPTDIR': '/data/run/chparada/renseq_assembly_snakemake/env_renseq_assembly/lib',
 'SETPGRP_HAVE_ARG': 0,
 'SGI_ABI': '',
 'SHELL': '/bin/sh',
 ...
 'TCLTK_INCLUDES': '-I/data/run/chparada/renseq_assembly_snakemake/env_renseq_assembly/include',
 'TCLTK_LIBS': '-L/data/run/chparada/renseq_assembly_snakemake/env_renseq_assembly/lib '
               '-ltcl8.6 -ltk8.6',
 'TESTOPTS': '',
 'TESTPATH': '',
 'TESTPYTHON': './python',
 ...
 'datarootdir': '/data/run/chparada/renseq_assembly_snakemake/env_renseq_assembly/share',
 'exec_prefix': '/data/run/chparada/renseq_assembly_snakemake/env_renseq_assembly',
 'prefix': '/data/run/chparada/renseq_assembly_snakemake/env_renseq_assembly',
